...
var _user$project$Main$decodeStoryData = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Main$initialModel = {title: 'A story', author: 'Me', content: 'this is some story content'};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {title: a, author: b, content: c};
	});
...
var _user$project$Main$getStory = function () {
	var storyUrl = '/stories/1';
	var req = A2(_elm_lang$http$Http$get, storyUrl, _user$project$Main$decodeStoryData);
